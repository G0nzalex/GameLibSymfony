 ...
 */
final class Version20220308132024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games_has_users (id INT AUTO_INCREMENT NOT NULL, games_id_game_id INT NOT NULL, users_id_user_id INT NOT NULL, id_platform INT NOT NULL, INDEX IDX_C0CCCEB79A375476 (games_id_game_id), INDEX IDX_C0CCCEB7AE98D571 (users_id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE platforms (id INT AUTO_INCREMENT NOT NULL, id_manufacturer_id INT NOT NULL, manufacturer_platform VARCHAR(255) NOT NULL, model_platform VARCHAR(255) NOT NULL, INDEX IDX_178186E3E37D77A5 (id_manufacturer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE games_has_users ADD CONSTRAINT FK_C0CCCEB79A375476 FOREIGN KEY (games_id_game_id) REFERENCES games (id)');
        $this->addSql('ALTER TABLE games_has_users ADD CONSTRAINT FK_C0CCCEB7AE98D571 FOREIGN KEY (users_id_user_id) REFERENCES users (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE games_has_users DROP FOREIGN KEY FK_C0CCCEB79A375476');
        ...
        $this->addSql('ALTER TABLE games_has_users DROP FOREIGN KEY FK_C0CCCEB7AE98D571');
